#Generated at 09/08/2020 08:38:55 by LIENHARD Laurent
enum FormatType
{
    UPPERCASE
    LOWERCASE
...
class USER
{
    ...
    [void] GetUpn ()
    {
        if ($This.IsAdUserExist())
        {
            $This.UPN = get-AdUser -Identity $This.SamAccountName -Properties UserPrincipalName | Select-Object -ExpandProperty UserPrincipalName
        }
    }
